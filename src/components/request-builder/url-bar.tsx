...
import { useCollections, useUpdateRequest, useCreateRequest } from '@/hooks/use-collections'
    ...
    <div className="flex gap-2 p-4">
      ...
      >
        <SelectTrigger className="w-[120px]">
          <SelectValue>
            <span className={cn('font-semibold', methodColors[tab.request.method])}>
              {tab.request.method}
            </span>
          </SelectValue>
        </SelectTrigger>
      ...
      <DialogContent>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={!selectedCollectionId || !saveName.trim() || createRequest.isPending}
          >
